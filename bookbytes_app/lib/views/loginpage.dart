...
import 'package:bookbytes_app/views/mainpage.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: const Text("User Login", style: TextStyle(color: Colors.black),),
  ...
  void _loginUser() {
    ...
    http.post(
        Uri.parse("${MyServerConfig.server}/bookbyte/php/login_user.php"),
