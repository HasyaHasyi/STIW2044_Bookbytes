...
class _CartPageState extends State<CartPage> {
  ...
  void loadUserCart() {
    ...
    http
        .get(
      Uri.parse(
          "${MyServerConfig.server}/bookbyte/php/loadcarts.php?userid=$userid"),
    )
        .then((response) {
  ...
  void deleteCart(int index) {
    print( cartList[index].cartId);
    http.post(Uri.parse("${MyServerConfig.server}/bookbyte/php/deletecarts.php"),
        body: {
